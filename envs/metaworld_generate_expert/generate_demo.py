...
for env_name in env_names:
	...
	# Initialize env
	mt1 = metaworld.MT1(env_name, seed=42) # Construct the benchmark, sampling tasks
	env = mt1.train_classes[env_name](render_mode='rgb_array')  # Create an environment with task `pick_place`
	...
	while episode < num_demos:
		...
		# Reset env
		observation, _ = env.reset()  # Reset environment
