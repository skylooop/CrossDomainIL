...
def collect_expert(cfg: DictConfig) -> None:
    ...
    restored_ckpt_target = checkpointer_net.restore("/home/m_bobrin/CrossDomainIL/outputs/2024-06-03/16-15-27/saved_encoding_agent")
    ...
    for i in pbar:
        ...
        target_buffer_agent.insert(observation, action, -10, mask, float(done), next_observation)
